...
\end{lstlisting}
\subsubsection[Ordonner selon angle]{Ordonner selon angle $\beta$}
\begin{lstlisting}
...
\end{lstlisting}
\subsubsection[Paire de points la plus proche]{Paire de points la plus proche  $\beta$}
\begin{lstlisting}
...
\end{lstlisting}
\subsection[Segments]{Segments $\beta$}
\begin{lstlisting}
...
\end{lstlisting}
\subsection[Triangles]{Triangles $\beta$}
...
\end{lstlisting}
\subsection[Cercles]{Cercles $\beta$}
...
\end{lstlisting}
\subsection[Polygones]{Polygones $\beta$}
...
\end{lstlisting}
\subsubsection[Polygone convexe: Graham Scan]{Polygone convexe: Graham Scan  $\beta$}
