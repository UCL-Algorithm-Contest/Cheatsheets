...
\end{lstlisting}
\subsection{Points {\footnotesize \textit{non-testé}}}
\begin{lstlisting}
...
\end{lstlisting}
\subsubsection{Ordonner selon angle {\footnotesize \textit{non-testé}}}
\begin{lstlisting}
...
\end{lstlisting}
\subsubsection{Paire de points la plus proche {\footnotesize \textit{non-testé}}}
\begin{lstlisting}
...
\end{lstlisting}
\subsection{Lignes {\footnotesize \textit{non-testé}}}
\begin{lstlisting}
class Line
{
  double a;
...
\end{lstlisting}
\subsection{Segments {\footnotesize \textit{non-testé}}}
\begin{lstlisting}
...
\end{lstlisting}
\subsection{Triangles {\footnotesize \textit{non-testé}}}
...
\end{lstlisting}
\subsection{Cercles {\footnotesize \textit{non-testé}}}
...
\end{lstlisting}
\subsection{Polygones {\footnotesize \textit{non-testé}}}
...
\end{lstlisting}
\subsubsection{Polygone convexe: Graham Scan {\footnotesize \textit{non-testé}}}
Meilleure complexité (théoriquement)
\begin{lstlisting}
static Point firstP;
