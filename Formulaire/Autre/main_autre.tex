...
\[ c_k = a * b = \sum_{i=0}^k a_i b_{k-i}. \]
We have $\mathsf{FFT}(a*b) = \mathsf{FFT}(a) \cdot \mathsf{FFT}(b)$ where $\cdot$ is the
entrywise product and FFT is $n \log(n)$!

\lstinputlisting{Autre/fft.java}
